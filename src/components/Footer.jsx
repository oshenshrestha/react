...
export default function Footer() {
    ...
    return (
        <footer>
            <div className="section-container py-[50px] sm:py-[100px] text-sm flex flex-col space-y-8 text-center justify-between sm:flex-row sm:space-y-0">
                <div className="flex space-x-8 max-w-[1000px]">
                    <div>
                        ...
                        <p className="mt-12">Happy Valentines Day!! I know its not much but wanted to create this little thing for you so you can
                            feel appreciated on this day. Im currenly making the paper flowers but when im done with the flowers youll get the non-virtual gift LMAO. But anwyays, try not to click around too much on this because as I was coding this
                    ...
                    <iframe width="500" height="400" src="https://open.spotify.com/embed/track/7FB6Nx7TK8y1Ke8dY6ROpQ?utm_source=generator&theme=0" title="keshi - Soft Spot (Acoustic) Official Audio" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
        </footer>
    )
